...
Please do not forgot to read the built-in documentation, which is available in [/inc/docs](http://plugins.svn.wordpress.org/hide-singular-title/tags/stable/inc/docs/index.html) folder.
